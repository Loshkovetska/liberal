        ...
        {data || (data && !data.length) ? (
          <>
            {data.map((bt: Bet, ind: number) => (
              <div
                className="account-bets-table__row"
                key={ind}
              >
                <div className="account-bets-table__td account-bets-table__td--main">
                  <span className="account-bets-table__td-title">
                    {bt.player.title}
                  </span>
                  <span className="account-bets-table__td-val">
                    {bt.match.title}
                  </span>
                </div>
                <div className="account-bets-table__td">
                ...
                <div className="account-bets-table__td account-bets-table__td--profit">
                  <span
                    className={classNames(
                      "account-bets-table__td-val",
                      bt.result === "Won" && "account-bets-table__td-val--won",
                    )}
                  >
                    {bt.result === "Won"
                      ? `£${bt.profit.toFixed(2)}`
